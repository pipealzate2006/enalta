    ...
    <header class="header">
        ...
        <nav class="nav" id="nav-menu">
            <div class="nav__content bd-grid">
                ...
                <div class="nav__social" style="display: block; margin-top: 15px;">
            ...
            <a href="../login/login.html"><button type="button" class="btn btn-info" style="margin-top: 15px;"><i class="fa-solid fa-right-from-bracket"></i> Iniciar Sesión</button></a>
        </nav>
    </header>
