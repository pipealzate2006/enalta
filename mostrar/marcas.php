...
<body>
    ...
    <button type="button" class="btn btn-success" id="bton" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@mdo"><i class="fa-solid fa-square-plus"></i> Agregar Registro de Marcas</button>
    <div class="container">
                ...
                while ($fila = mysqli_fetch_array($consulta)) { ?>
                    <tr>
                        ...
                        <td style="text-align: center;">
                            <a href="#marcas<?php echo $fila[0]; ?>" class="btn btn-success" data-bs-toggle="modal" id="btn">
                                <i class="fa-regular fa-pen-to-square"></i>
                                <a href="#marcasEliminar<?php echo $fila[0]; ?>" class="btn btn-danger" data-bs-toggle="modal" id="btn" style="margin-left: 10px;">
                                    <i class="fa-solid fa-trash"></i>
                                </a>
                            </a>
                        </td>
                    </tr>
                    <?php include '../eliminar/modal-marcas.php';
                    include '../actualizar/modal-marcas.php'; ?>
                <?php
                }
                ?>
        </table>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Nuevo registro para Marcas</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form method="post" action="../procesoRegistros/marcas.php" class="row g-3" id="centrar">
                        <div class="row">
                            <div class="col-md-6">
