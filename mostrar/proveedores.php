...
<body>
    ...
    <button type="button" class="btn btn-success" id="bton" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@mdo"><i class="fa-solid fa-square-plus"></i> Agregar Registro de Proveedores</button>
    <div class="container">
        <table id="proveedores" class="table table-striped table-bordered" cellspacing="0" width="100%">
            <thead>
                <tr class="table-dark">
                    <th>ID</th>
                    <th>Cedula</th>
                ...
                while ($fila = mysqli_fetch_array($consulta)) { ?>
                    <tr>
                        ...
                        <td style="text-align: center;">
                            <a href="#proveedores<?php echo $fila['id']; ?>" class="btn btn-success" data-bs-toggle="modal"><i class="fa-regular fa-pen-to-square"></i></a>
                            <a href="#proveedoresEliminar<?php echo $fila[0]; ?>" class="btn btn-danger" data-bs-toggle="modal" style="margin-left: 10px;"><i class="fa-solid fa-trash"></i></a>
                        </td>
                    </tr>
                    <?php include '../actualizar/modal-proveedores.php'; ?>
                <?php
                }
                ?>
        </table>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Nuevo registro para Proveedores</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form method="post" action="../procesoRegistros/proveedores.php" class="row g-3" id="centrar">
                        <div class="row">
                            <div class="col-md-6">
